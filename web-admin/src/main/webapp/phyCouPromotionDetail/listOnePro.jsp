...
<%
  PhyCouProVO phyCouProVO = (PhyCouProVO) request.getAttribute("phyCouProVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>

<html>
<head>
<title>Promotion 資料 - listOnePro.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>Promotion 資料 - ListOnePro.jsp</h3>
